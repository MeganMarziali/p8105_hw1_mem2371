...
num_of_log = as.numeric(pull(prob_one_df, vec_logical))

num_of_log

num_of_char = as.numeric(pull(prob_one_df, vec_char))

num_of_char

num_of_fac = as.numeric(pull(prob_one_df, vec_factor))
...
```{r}
num_log_by_random = as.numeric(pull(prob_one_df, vec_logical)) * (pull(prob_one_df, vec_norm))

# Calling the variable to double-check the above function

num_log_by_random 

fact_log_by_random = as.factor(pull(prob_one_df, vec_logical)) * (pull(prob_one_df, vec_norm))

fact_of_log = as.factor(pull(prob_one_df, vec_logical))

fact_num_by_random = as.numeric(fact_log) * (pull(prob_one_df, vec_norm))
